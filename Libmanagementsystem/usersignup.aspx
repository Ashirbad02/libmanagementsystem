<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="Libmanagementsystem.usersignup1" %>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Second Row: Contact Number and Email ID -->
                        <div class="row">
                            <div class="col-md-6">
                                <label>Contact Number</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBoxContact" runat="server" placeholder="Contact Number" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <!-- Third Row: State (Dropdown), City, and Pincode -->
                        <div class="row">
                            <div class="col-md-4">
                                <label>State</label>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <label>City</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBoxCity" runat="server" placeholder="City"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label>Pincode</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBoxPincode" runat="server" placeholder="Pincode" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Blue Badge for Login Credentials (Centered) -->
                        <div class="row">
                            <center>
                            <div class="col">
                        ...
                        <!-- Sixth Row: User ID and Password -->
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:Button CssClass="btn btn-success btn-block" ID="ButtonSignUp" runat="server" Text="Sign Up" OnClick="ButtonSignUp_Click" />
                            </div>
                        </div>
